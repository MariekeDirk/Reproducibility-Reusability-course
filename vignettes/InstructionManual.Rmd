...
# Introduction
Reproducability of research is becomming more and more important ([nature special](http://www.nature.com/news/reproducibility-1.17552)). If we cann't reproduce research results, how can we use them for future research? What is the value of irreproducable conclusions? To improve reproducability training is important to boost reproducability ([nature,2016](http://www.nature.com/news/1-500-scientists-lift-the-lid-on-reproducibility-1.19970)). 

![](/nobackup/users/dirksen/Reproducability-Reusability-course/vignettes/img/reproducibility-graphic.jpg)

During this course we will introduce you to tools to make your code reproducable and re-usable for other researchers. As it's not posible to introduce you to all software we made a selection. Our focus will be on the reproducability of code by intrdoducing you to:
...
For a fully reproducable research you also want to link your data to GitHub, which is posible with e.g. [Docker](https://docs.docker.com/docker-hub/github/). 
...
* The code and instruction manual, can be found [here](https://github.com/MariekeDirk/Reproducability-Reusability-course.git)
...
* To see if your branch passes the test you can add an image [![Build Status](https://travis-ci.org/MariekeDirk/Reproducability-Reusability-course.svg?branch=master)](https://travis-ci.org/MariekeDirk/Reproducability-Reusability-course)

To this repository the .travis.yml file inlcudes the following code:
```{r,eval=FALSE}
language: R
sudo: false
cache: packages
